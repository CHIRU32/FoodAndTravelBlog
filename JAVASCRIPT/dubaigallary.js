...
function header()
{
    ...
    {
        i=0;
        document.getElementById("header").style.backgroundImage=`url(../assets/images/dubai/${arrayImages[i]})`
    }
    else
    {
        document.getElementById("header").style.backgroundImage=`url(../assets/images/dubai/${arrayImages[i]})`
...
{   
    document.getElementById("gib").setAttribute("src",`../assets/images/dubai/${img}.jpg`);
