var arrayImages=["0.jpg","1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","9.jpg","10.jpg"]
var i=0;
function header()
{
    if(i>=10)
    {
        i=0;
        document.getElementById("header").style.backgroundImage=`url(../assets/images/india/${arrayImages[i]})`
    }
    else
    {
        document.getElementById("header").style.backgroundImage=`url(../assets/images/india/${arrayImages[i]})`
...
{   
    document.getElementById("gib").setAttribute("src",`../assets/images/india/${img}.jpg`);
