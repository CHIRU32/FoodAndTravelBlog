...
function header()
{
    ...
    {
        i=0;
        document.getElementById("header").style.backgroundImage=`url(../assets/images/japan/${arrayImages[i]})`
    }
    else
    {
        document.getElementById("header").style.backgroundImage=`url(../assets/images/japan/${arrayImages[i]})`
...
{   
    document.getElementById("gib").setAttribute("src",`../assets/images/japan/${img}.jpg`);
